...
# def translate_business_day_convention(convention: str):
#     """
#     Translate a string to the corresponding QuantLib BusinessDayConvention.

#     Args:
#         convention (str): The business day convention as a string.

#     Returns:
#         ql.BusinessDayConvention: The corresponding QuantLib convention.
...
#     except KeyError:
#         raise ValueError(f"Unsupported business day convention: {convention}. Supported: {list(mapping.keys())}")


# def translate_date_generation_rule(rule: str):
#     """
#     Translate a string to the corresponding QuantLib DateGeneration.Rule.

#     Args:
#         rule (str): The date generation rule as a string.

#     Returns:
#         ql.DateGeneration.Rule: The corresponding QuantLib rule.
...
#         return mapping[rule]
#     except KeyError:
#         raise ValueError(f"Unsupported date generation rule: {rule}. Supported: {list(mapping.keys())}")
...
#     termination_date_business_day_convention: str,
#     date_generation_rule: str,
#     currency: str
# ) -> float:
...
#         ql.Period(frequency),
#         calendar,
#         translate_business_day_convention(business_convention),
#         translate_business_day_convention(termination_date_business_day_convention),
#         translate_date_generation_rule(date_generation_rule),
